...
<html>
	<head>
	<meta charset="utf-8">
	<title>Rekomendasi Konsentrasi - RKM2</title>
...
<script src="asset/theme/blue_strap/js/redactor/jquery-1.7.min.js" type="text/javascript"></script>
				...
				<div class="container-fluid">
					<!--<div class="row-fluid">			
						<div class="nav-collapse collapse">							 		                 
							<ul class="nav pull-left"><li><a href="web/pages/get/1/beranda"><i class="icon-home"></i> BERANDA</a></li><li><a href="web/pages/get/2/tentang-kami"><i class="icon-fire"></i> TENTANG KAMI</a></li><li><a href="web/pages/get/3/indexs-member"><i class="icon-user"></i> INDEXS MEMBER</a></li><li><a href="web/pages/get/4/indexs-iklan"><i class="icon-tags"></i> INDEXS IKLAN</a></li><li><a href="web/pages/get/5/artikel"><i class="icon-leaf"></i> ARTIKEL</a></li></ul>							 		                 
							<ul class="nav pull-right"><li><a href="web/pages/get/6/sign-up-member"><i class="icon-share"></i> SIGN UP MEMBER</a></li><li><a href="web/pages/get/7/sign-in-member"><i class="icon-check"></i> SIGN IN MEMBER</a></li></ul>			
	...
	$Angkatan = $_POST['Angkatan'];
	  ...
	  $Konsentrasi = $_POST['Konsentrasi'];
	   if($Angkatan=="" || $JenisKelamin=="" || $IPK=="" || $NilaiIUM462=="" || $NilaiIKL435=="" || $NilaiIKH413=="" || $NilaiIKH451=="" || $NilaiUBA403=="" || $NilaiIKB411==""){
